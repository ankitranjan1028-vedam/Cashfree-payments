...
//       // Handle cases where payment method is an object
...
//       // Fallback: return the first available value or stringify
...
//             <div style={{ marginBottom: '10px' }}>
//               <strong>Transaction ID:</strong> {paymentData.cfPaymentId}
//             </div>
//           )}
//           <div style={{ marginBottom: '10px' }}>
...
//             <div style={{ marginBottom: '10px' }}>
//               <strong>Payment Method:</strong> {formatPaymentMethod(paymentData.paymentMethod)}
//             </div>
//           )}
//           {paymentData.paymentTime && (
//             <div style={{ marginBottom: '10px' }}>
//               <strong>Payment Time:</strong> {new Date(paymentData.paymentTime).toLocaleString()}
//             </div>
//           )}
